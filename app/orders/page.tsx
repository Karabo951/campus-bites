      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          {orders.length === 0 ? (
            ...
            orders.map((order) => (
              <div key={order.id} className="bg-white p-5 rounded-xl border border-gray-200 space-y-3 shadow-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-xs font-extrabold uppercase px-2.5 py-1 rounded bg-gray-100 text-gray-700 self-start">
                    {order.status}
                  </span>
                </div>
