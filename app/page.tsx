...
export default function Home() {
  // Set to `true` to display the "Website Suspended" error screen
  // Set to `false` to restore normal website functionality
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-neutral-100 p-6 sm:p-12 relative">
      {/* 1. Fake Suspension Notice Overlay */}
      <SuspensionNotice isSuspended={isSuspended} />

      {/* 2. Main Site UI (Hidden when isSuspended is true) */}
      <div className={isSuspended ? 'hidden' : 'block'}>
